...
export const NavBar = () => {
  ...
  return (
    <div className="sticky top-0 px-2 bg-white bg-opacity-100 ">
        ...
        {user ? (
          <div className="flex items-center space-x-4 bg-white ">
            ...
            <button
              ...
              className="flex transition-colors w-20 h-8 items-center justify-center m-1 bg-red-600 text-white p-2 rounded-lg hover:bg-red-700"
            >
              Salir
            </button>
          </div>
